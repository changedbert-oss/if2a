...
class MahasiswaController extends Controller
{
    ...
    {
        // akses rabel prodi untuk menampilkan pilihan prodi di form
        $prodi = Prodi::all();
        return view('mahasiswa.create', compact('prodi')); // kirim data ke viwe
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'foto' => 'nullable|image|mimes:jpegmpng,jpg,gif|max:2048',
        ]);
        ...
        if ($request->hasFile('foto')) {
            ...
            $foto->storeAs('fotos', $nama_foto, 'public'); // simpan foto di folder storage/app/fotos/public
        } else {
        ...
        // Redirect ke alaman idex dengan pesan sukses
